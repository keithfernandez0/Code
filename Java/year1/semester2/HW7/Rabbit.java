...
public class Rabbit extends MyPetStore

{
    ...
    public Rabbit(String name, LocalDate birthDate, double price, String speciesType, String specialFeature, boolean isBites) 
    {
